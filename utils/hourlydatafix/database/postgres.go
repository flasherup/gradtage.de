...
//GetAll get a list of temperatures form table @name (station Id)
func (pg *Postgres) GetAll(name string) (temps []hourlysvc.Temperature, err error) {
	query := fmt.Sprintf("SELECT * FROM %s ORDER BY date::timestamp ASC;", name)
