...
func (ss HourlySVC) GetPeriod(ctx context.Context, id string, start string, end string) (temps []hourlysvc.Temperature, err error) {
...
func (ss HourlySVC) PushPeriod(ctx context.Context, id string, temps []hourlysvc.Temperature) (err error){
